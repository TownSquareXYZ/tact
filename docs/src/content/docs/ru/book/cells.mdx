...
Подобно параметрам сериализации типа [`Int{:tact}`](/ru/book/integers), `Cell{:tact}`, `Builder{:tact}` и `Slice{:tact}` также имеют различные представления для кодирования своих значений в следующих случаях:

- как [переменные хранения](/ru/book/contracts#variables) [контрактов](/ru/book/contracts) и [типажей](/ru/book/types#traits),
- и как поля [структур](/ru/book/structs-and-messages#structs) и [сообщений](/ru/book/structs-and-messages#messages).
...
:::note
  ...
  Обратите внимание, что ячейка, сериализованная с помощью `as remain{:tact}`, не может быть [необязательной](/ru/book/optionals). То есть указание чего-то вроде `Cell? as remain{:tact}`, `Builder? as remain{:tact}` или `Slice? as remain{:tact}` вызовет ошибку компиляции.

  Также обратите внимание, что указание `remaining{:tact}` для `Cell{:tact}` как типа значения [карты](/ru/book/maps) считается ошибкой и не будет компилироваться.
...
- [Вручную](#cnp-manually), что подразумевает активное использование [`Builder{:tact}`](#builders), [`Slice{:tact}`](#slices) и [соответствующих методов](/ru/ref/core-cells).
...
[b-1]: /ru/ref/core-cells#begincell
[b-2]: /ru/ref/core-cells#builderstoreuint
[b-3]: /ru/ref/core-cells#builderstoreint
[b-4]: /ru/ref/core-cells#builderstorebool
[b-5]: /ru/ref/core-cells#builderstoreslice
[b-6]: /ru/ref/core-cells#builderstorecoins
[b-7]: /ru/ref/core-cells#builderstoreaddress
[b-8]: /ru/ref/core-cells#builderstoreref
[b-9]: /ru/ref/core-cells#builderendcell
[s-1]: /ru/ref/core-cells#cellbeginparse
[s-2]: /ru/ref/core-cells#sliceloaduint
[s-3]: /ru/ref/core-cells#sliceloadint
[s-4]: /ru/ref/core-cells#sliceloadbool
[s-5]: /ru/ref/core-cells#sliceloadbits
[s-6]: /ru/ref/core-cells#sliceloadcoins
[s-7]: /ru/ref/core-cells#sliceloadaddress
[s-8]: /ru/ref/core-cells#sliceloadref
[s-9]: /ru/ref/core-cells#sliceendparse
...
Настоятельно рекомендуется использовать их и их [методы](/ru/book/functions#extension-function), такие как [`Struct.toCell(){:tact}`][st-tc] и [`Struct.fromCell(){:tact}`][st-fc] вместо ручного создания и анализа ячеек, поскольку это позволяет создавать гораздо более декларативные и понятные контракты.
...
:::note[Useful Полезные ссылки:]
  ...
  [Преобразование сериализации](/ru/book/func#convert-serialization)\
...
Чтобы также выдать [код выхода 9](/ru/book/exit-codes#9) всякий раз, когда [`Slice{:tact}`](#slices) не полностью пуст, используйте [`Slice.endParse(){:tact}`][s-ep].
...
:::note[Useful Полезные ссылки:]
  ...
  [`Cell.asSlice(){:tact}` в основной библиотеке](/ru/ref/core-cells#cellasslice)\
[`Builder.asSlice(){:tact}` в основной библиотеке](/ru/ref/core-cells#builderasslice)\
...
[s-de]: /ru/ref/core-cells#slicedataempty
[s-re]: /ru/ref/core-cells#slicerefsempty
[s-e]: /ru/ref/core-cells#sliceempty
[s-ep]: /ru/ref/core-cells#sliceendparse
...
:::note[Useful Полезные ссылки:]
  ...
  [`Cell.hash(){:tact}` в основной библиотеке](/ru/ref/core-cells#cellhash)\
[`Slice.hash(){:tact}` в основной библиотеке](/ru/ref/core-cells#slicehash)\
[`=={:tact}` и `!={:tact}`][bin-eq]
...
[recv]: /ru/book/contracts#receiver-functions
[jetton]: /ru/cookbook/jettons
[tvm]: https://docs.ton.org/learn/tvm-instructions/tvm-overview
[tlb]: https://docs.ton.org/develop/data-formats/tl-b-language
[sha-2]: https://en.wikipedia.org/wiki/SHA-2#Hash_standard
[quadtree]: https://en.wikipedia.org/wiki/Quadtree
[bin-eq]: /ru/book/operators#binary-equality
