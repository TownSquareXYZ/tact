...
На этой странице представлены примеры преобразования между [примитивными типами][p] и получения их из [составных типов](/book/types#composite-types).
...
:::note[Useful [Полезные ссылки:]
  ...
  [`Int.toString(){:tact}` в библиотеке Core](/ref/core-strings#inttostring)\
  [`Int.toFloatString(){:tact}` в библиотеке Core](/ref/core-strings#inttofloatstring)\
  [`Int.toCoinsString(){:tact}` в библиотеке Core](/ref/core-strings#inttocoinsstring)
...
:::note[Useful [Полезные ссылки:]
  ...
  [`Struct.toCell(){:tact}` в библиотеке Core](/ref/core-cells#structtocell)\
  [`Message.toCell(){:tact}` в библиотеке Core](/ref/core-cells#messagetocell)
...
:::note[Useful [Полезные ссылки:]
  ...
  [`Struct.fromCell(){:tact}` в библиотеке Core](/ref/core-cells#structfromcell)\
  [`Struct.fromSlice(){:tact}` в библиотеке Core](/ref/core-cells#structfromslice)\
  [`Message.fromCell(){:tact}`в библиотеке Core](/ref/core-cells#messagefromcell)\
  [`Message.fromSlice(){:tact}`в библиотеке Core](/ref/core-cells#messagefromslice)
