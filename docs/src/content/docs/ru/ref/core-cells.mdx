...
:::note
  ...
  Всем пользователям рекомендуется использовать [структуры][struct] и их [методы](/book/functions#extension-function), такие как [`Struct.toCell(){:tact}`](#structtocell) и [`Struct.fromCell(){:tact}`](#structfromcell) вместо ручного создания и парсинга ячеек, потому что [Structs][struct] и [Messages][message] ближе всего к [живыми TL-B схемам ваших контрактов](/book/cells#cnp-structs).
...
Попытки сохранить отрицательное `value` или указать недостаточное или выходящее за пределы значение `bits` число вызывают исключение с [кодом завершения 5](/book/exit-codes#5): `Integer out of expected range`.
...
Попытки указать недостаточное или выходящее за пределы значение `bits` вызываю исключение с [кодом завершения 5](/book/exit-codes#5): `Integer out of expected range`.
...
Попытки сохранить значение `value`, выходящее за пределы допустимого диапазона, вызывают исключение с [кодом завершения 5](/book/exit-codes#5): `Integer out of expected range`.
...
:::note[Useful [Полезные ссылки:]
  ...
  [Специальный тип сериализации `coins`](/book/integers#serialization-coins)
...
Поскольку одна [`Cell{:tact}`][cell] может содержать до $4$ ссылок, попытки сохранить больше вызывают исключение с [кодом завершения 8](/book/exit-codes#8): `Cell overflow`.
...
Попытки указать значение `l`, выходящее за пределы допустимого диапазона, вызывают исключение с [кодом завершения 5](/book/exit-codes#5): `Integer out of expected range`.

Попытки загрузить больше данных, чем содержится в [`Slice{:tact}`][slice], вызывают исключение с [кодом завершения 9](/book/exit-codes#9): `Cell underflow`.
...
Попытки предзагрузить больше данных, чем содержится в [`Slice{:tact}`][slice], вызывают исключение с [кодом завершения 9](/book/exit-codes#9): `Cell underflow`.
...
Попытки указать значение `l`, выходящее пределы допустимого диапазона, вызывают исключение с [кодом завершения 5](/book/exit-codes#5): `Integer out of expected range`.
...
Попытки загрузить такой [`Bool{:tact}`][bool], если [`Slice{:tact}`][slice] его не содержит, вызывают исключение с [кодом завершения 8](/book/exit-codes#8): `Cell overflow`.
...
Загружает и возвращает [сериализованное](#builderstorecoins) беззнаковое значение [`Int{:tact}`][int] в диапазоне $0 .. 2^{120} - 1$ из [`Slice{:tact}`][slice]. Это значение обычно представляет собой сумму в [нанотонкоинах](/book/integers#nanotoncoin).

Попытки загрузить такое [`Int{:tact}`][int], если [`Slice{:tact}`][slice] его не содержит, вызывают исключение с [кодом завершения 8](/book/exit-codes#8): `Cell overflow`.
...
Попытки загрузить такой [`Address{:tact}`][p] если [`Slice{:tact}`][slice] его не содержит, вызывают исключение с [кодом завершения 8](/book/exit-codes#8): `Cell overflow`.
...
Попытки загрузить такую ссылку [`Cell{:tact}`][cell], если [`Slice{:tact}`][slice] не содержит ее, вызывают исключение с [кодом завершения 8](/book/exit-codes#8): `Cell overflow`.
...
Попытки предзагрузить такую ссылку [`Cell{:tact}`][cell], если [`Slice{:tact}`][slice] не содержит ее, вызывают исключение с [кодом завершения 8](/book/exit-codes#8): `Cell overflow`.
...
Проверяет, является ли [`Slice{:tact}`][slice] пустым (т.е. не содержит ни бит данных и ни ссылок на ячейки). Если нет, вызывает исключение с [кодом завершения 9](/book/exit-codes#9): `Cell underflow`.
...
Попытки передать [`Cell{:tact}`][cell] с макетом, отличным от указанного [Struct][struct], или загрузить больше данных, чем содержит [`Cell{:tact}`][cell], вызывают исключение с [кодом завершения 9](/book/exit-codes#9): `Cell underflow`.
...
Попытки передать [`Slice{:tact}`][slice] с макетом, отличным от указанной [Struct][struct], или загрузить больше данных, чем содержит [`Slice{:tact}`][slice], вызывают исключение с [кодом завершения 9](/book/exit-codes#9): `Cell underflow`.
...
Попытки передать [`Cell{:tact}`][cell] с макетом, отличным от указанного [Message][message], или загрузить больше данных, чем содержит [`Cell{:tact}`][cell], вызывают исключение с [кодом завершения 9](/book/exit-codes#9): `Cell underflow`.
...
Попытки передать [`Slice{:tact}`][slice] с макетом, отличным от указанного [Message][message], или загрузить больше данных, чем содержит [`Slice{:tact}`][slice], вызывают исключение с [кодом завершения 9](/book/exit-codes#9): `Cell underflow`.
