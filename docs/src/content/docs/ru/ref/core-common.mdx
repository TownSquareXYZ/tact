...
:::caution
  ...
  Помните, что [все функции отправки сообщений](/book/send#message-sending-functions) Tact могут изменить _фактический_ баланс контракта, но они _не_ будут обновлять значение, возвращаемое этой функцией.
