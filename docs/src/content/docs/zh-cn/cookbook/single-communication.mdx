...
如果我们需要发送智能合约的全部余额，则应使用 `SendRemainingBalance{:tact}` 发送模式。  或者，我们也可以使用 `mode：128{:tact}`，其含义相同。 或者，我们也可以使用 `mode：128{:tact}`，其含义相同。
...
:::tip[Hey there!]
  ...
  没有找到您最喜欢的单一合约通信案例？  您有很酷的实施方案吗？ [欢迎投稿！](https://github.com/tact-lang/tact/issues) 您有很酷的实施方案吗？ [欢迎投稿！](https://github.com/tact-lang/tact/issues)
